...
import org.apache.spark.sql.execution.{ColumnarRule, FileSourceScanExec, LocalTableScanExec, SparkPlan}
  ...
  override def preColumnarTransitions: Rule[SparkPlan] = {
    new Rule[SparkPlan] {
      override def apply(sparkPlan: SparkPlan): SparkPlan = {
        ...
        if (sparkPlan.isInstanceOf[FileSourceScanExec] && sparkPlan.asInstanceOf[FileSourceScanExec].relation.fileFormat.isInstanceOf[DeltaParquetFileFormat]) {
          return sparkPlan
        }
